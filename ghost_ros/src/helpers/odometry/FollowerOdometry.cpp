 ...
 */
void FollowerOdometry::Update(double x_encoder_raw_ticks, double y_encoder_raw_ticks, Eigen::Rotation2Dd gyro_angle) {
    ...
    Eigen::Rotation2Dd angle_delta = (gyro_angle * IOdometry::m_gyro_initial_angle.inverse()) 
    ...
    Eigen::Vector2d robot_translation(x_delta, y_delta);
    ...
    robot_translation = (IOdometry::m_robot_pose.angle.inverse() * Eigen::Rotation2Dd(M_PI_2)).inverse() * robot_translation;
